...
from BasicFunction.firebase_db_connect import get, post_daily_tracking, update, delete 
...
def COVID_TRACKER_APP(UID, PROFILE_NAME, TEXT_FROM_USER, SESSION):
    ...
    post_daily_tracking(uid=_input_name, 
        data=result, 
